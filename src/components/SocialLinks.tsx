  ...
  return (
    <div className="space-y-4">
      ...
      <a
        ...
        className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-lg hover:bg-primary-50 dark:hover:bg-slate-600 transition-colors group"
      >
        <svg className="w-6 h-6 text-primary-600 dark:text-accent-400 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
